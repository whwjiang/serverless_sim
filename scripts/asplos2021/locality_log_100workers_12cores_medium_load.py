...
OUTPUT_FILE = "../../out/eurosys2021revision/locality_log_100workers_12cores_medium_load"
...
def main():
    ...
    loads = [0.05 * i for i in range(10,15)] #+ [0.96, 0.97, 0.98, 0.99]
    for i in loads:
